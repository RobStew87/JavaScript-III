...
SandwichMaker.prototype.finish = function(){
   return `Robert cooks in his ${this.uniform} and uses a ${this.tool} and ${this.machine} to make his sandwiches`;
}
const Robert = new SandwichMaker ('apron', 'panini maker', 'knife')

console.log(Robert);                                  // SandwichMaker { uniform: 'apron', machine: 'panini maker', tool: 'knife' }
console.log(`I enjoy using ${Robert.machine}s`);      // I enjoy using panini makers      
console.log(Robert.finish());
...
grill.call(sandwich4);   // so 'this' keyword is being forced upon 'sandwich4' properties because the function 'grill' is passing 'sandwich4' as the argument
 //once again sorry for doing a food subject in my code I love food and tried to leave comments that were informational and basic sandwich types.